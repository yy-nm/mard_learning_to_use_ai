...
class ConversationManager:
	# 联网功能需要特定模型， 除非自行部署 MCP 进行支持
	def __init__(self, model="openai/gpt-4o-mini-search-preview", max_tokens=12000):
		self.client = OpenAI(
		...
		self.messages = [
			{"role": "system", "content": "你是一个可以联网的 AI 助手，遇到需要实时信息时可以调用 web_search 工具。"}
		]
